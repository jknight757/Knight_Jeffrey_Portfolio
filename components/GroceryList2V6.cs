    ...
    {       
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    myStream.WriteLine("Haves");                              //writes the list name to the file
                    foreach (string item in needs) 
                    {
                        myStream.WriteLine(" "+item);                         //writes the list contents to the file
                    }
                    myStream.WriteLine(" ");
                    myStream.WriteLine("Wants");                              //writes the list name to the file
